...
import CubeJsLogo from "../assets/cube.png";
      ...
      <div className="item_container">
        <div className="item_text_intro">
          ...
          <div className="technologies_container">
            ...
            <Flip delay={500} left>
              <img alt="logo" src={MongoDbLogo} className="technologiesLogo" />
            </Flip>
            <Flip delay={500} left>
              <img alt="logo" src={CubeJsLogo} className="technologiesLogo" />
            </Flip>
          </div>
        </div>
        <div>
          <ExpandMoreIcon
            ...
            onClick={(reftoScroll) => onClickScrollDown(refToScroll)}
